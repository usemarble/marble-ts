 ...
 */
export function fieldsPostV1Fields(
  client: MarbleCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.CreateFieldBody$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.FieldResponse$inboundSchema),
