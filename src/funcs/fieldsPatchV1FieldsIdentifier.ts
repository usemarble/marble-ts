 ...
 */
export function fieldsPatchV1FieldsIdentifier(
  client: MarbleCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.PatchV1FieldsIdentifierRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/fields/{identifier}")(pathParams);
  ...
  const context = {
    ...
    operationID: "patch_/v1/fields/{identifier}",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.FieldResponse$inboundSchema),
