 ...
 */
export function tagsPatchV1TagsIdentifier(
  client: MarbleCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.PatchV1TagsIdentifierRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/tags/{identifier}")(pathParams);
  ...
  const context = {
    ...
    operationID: "patch_/v1/tags/{identifier}",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CreateTagResponse$inboundSchema),
