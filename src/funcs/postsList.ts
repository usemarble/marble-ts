...
export function postsList(
  ...
  PageIterator<
    Result<
      operations.GetV1PostsResponse,
      | errors.GetV1PostsBadRequest
      | errors.ServerError
      | MarbleError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(operations.GetV1PostsRequest$outboundSchema), value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetV1PostsResponse$inboundSchema, { key: "Result" }),
    M.jsonErr(400, errors.GetV1PostsBadRequest$inboundSchema),
