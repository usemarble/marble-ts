 ...
 */
export function fieldsDeleteV1FieldsIdentifier(
  client: MarbleCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteV1FieldsIdentifierRequest$outboundSchema, value),
  ...
  const context = {
    ...
    operationID: "delete_/v1/fields/{identifier}",
    oAuth2Scopes: null,
