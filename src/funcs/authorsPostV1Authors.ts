 ...
 */
export function authorsPostV1Authors(
  client: MarbleCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.CreateAuthorBody$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateAuthorResponse$inboundSchema),
