...
| `fields`                                                                                        | Record<string, *models.PostFields*>                                                             | :heavy_check_mark:                                                                              | Custom field values keyed by field key                                                          | {<br/>"release_date": "2024-01-15",<br/>"priority_score": 5,<br/>"hashtags": [<br/>"#javascript",<br/>"#nextjs"<br/>]<br/>} |
